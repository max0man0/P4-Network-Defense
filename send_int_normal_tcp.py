import time
from scapy.layers.inet6 import IPv6, Ether,TCP
import psutil
import socket
...
def send_normal_traffic(target_ip, target_port, interval=0.5, count=556):
    ...
    for i in range(count):
        packet = Ether(src=get_if_hwaddr(INTERFACE), dst="02:01:01:01:00:01") / \
                 ...
                 TCP(dport=DST_PORT, flags="S", options=[("Timestamp", (i+1, 0))])  # was 1000
